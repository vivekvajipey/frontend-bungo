      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          <Input
            ...
            className="bg-transparent border-2 border-red-500/20 text-red-500 text-xl py-6 px-4 rounded-lg 
          ...
          <motion.button
            ...
            className="w-full bg-red-500/10 text-red-500 border-2 border-red-500/20 hover:bg-red-500/20 
                     hover:border-red-500/40 rounded-lg py-6 text-xl font-bold tracking-widest
